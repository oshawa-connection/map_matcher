...
def train(model, dataloader, val_loader, device, epochs=50, patience=10):
    ...
    for epoch in range(epochs):
        ...
        val_loss, val_precision = evaluate(model, val_loader, device)
        print(f"Validation Loss: {val_loss:.4f} | Precision: {val_precision:}")
...
if __name__ == "__main__":
    ...
    val_loss, val_precision = evaluate(model, test_loader, device)
    print(f"Eval Loss: {val_loss:.4f} - Eval Precision: {val_precision:.4f}")